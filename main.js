...
//contenedor1.create({tittle:'teclado', price: 2000, thumbnail: 'https://www.funcionaCagadaDeMierda.com'})
//contenedor1.save({tittle:'teclado2', price: 8000, thumbnail: 'https://www.funcionaCagadaDeMierda2.com'})

//Segunda ejecución: Añade un tercer producto
//contenedor1.save({tittle:'mouse', price: 50000, thumbnail: 'https://www.funcionaCagadaDeMierda8.com'})
